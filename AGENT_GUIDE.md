...
Para lidar com o acoplamento do código original, o Studio adotará o padrão **Builder** para construir a interface visual. Isso permite separar a *criação* dos widgets da *lógica* de execução do Showbox.
...
*   *Nota:* Focar apenas no bloco Showbox, ignorar lógica shell complexa ao redor.
